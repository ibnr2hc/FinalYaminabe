...
const randomRoleForFourPlayer = (users: UserType[]): DecidedUserAndRoleType[] => {
    /* ランダムにロールを決める */
...
export { classNames, existsUndefinedRole, getSelectedRole, randomRole, randomRoleForAllianceRaid, randomRoleForFourPlayer, randomRoleForNormalRaid };
