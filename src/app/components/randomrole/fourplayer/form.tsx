...
import { randomRoleForFourPlayer } from "@/app/components/randomrole/applications/random_role"
...
export default function RandomRoleFourPlayerForm() {
    ...
    const submitHandler = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const userAndRoles = randomRoleForFourPlayer(users)
