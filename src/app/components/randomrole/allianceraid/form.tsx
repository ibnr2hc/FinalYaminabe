...
import { randomRoleForAllianceRaid } from "@/app/components/randomrole/applications/random_role"
...
export default function RandomRoleAllianceRaidForm() {
    ...
    const submitHandler = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const userAndRoles = randomRoleForAllianceRaid(users)
